...
# GUI for program using grid labels
def load_gui(self):
    self.lbl_fname = tk.Label(self.master,text='First Name:')
    self.lbl_fname.grid(row=0,column=0,padx=(27,0),pady=(10,0),sticky=N+W)
    self.lbl_lname = tk.Label(self.master,text='Last Name:')
    self.lbl_lname.grid(row=2,column=0,padx=(27,0),pady=(10,0),sticky=N+W)
    self.lbl_phone = tk.Label(self.master,text='Phone Numer:')
    ...
    self.btn_submit = tk.Button(self.master,width=12,height=2,text='Submit',command=lambda: student_tracker_func.addToList(self))
    self.btn_submit.grid(row=10,column=0,padx=(25,0),pady=(10,10),sticky=W)
    self.btn_delete = tk.Button(self.master,width=12,height=2,text='Delete',command=lambda: student_tracker_func.onDelete(self))
    self.btn_delete.grid(row=10,column=1,padx=(15,0),pady=(10,10),sticky=W)
